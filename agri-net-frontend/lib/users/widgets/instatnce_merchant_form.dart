...
class MerchantInstanceForm extends StatefulWidget {
  Function callback;
  MerchantInstanceForm(this.callback);

  @override
  State<MerchantInstanceForm> createState() => _MerchantInstanceFormState();
}

class _MerchantInstanceFormState extends State<MerchantInstanceForm> {
