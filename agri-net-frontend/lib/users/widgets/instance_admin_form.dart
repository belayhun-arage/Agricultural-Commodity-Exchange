...
class AdminInstanceForm extends StatefulWidget {
  static String RouteName = "admin/new";
  const AdminInstanceForm({Key? key}) : super(key: key);

  @override
  State<AdminInstanceForm> createState() => _AdminInstanceFormState();
}

class _AdminInstanceFormState extends State<AdminInstanceForm> {
