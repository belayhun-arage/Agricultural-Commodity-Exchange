...
class AmendTransactionForBuyerPopup extends StatefulWidget {
  Transaction transaction;
  TransactionRequest transactionReq;
  AmendTransactionForBuyerPopup(this.transaction, this.transactionReq,
      {Key? key})
      : super(key: key);

  @override
  State<AmendTransactionForBuyerPopup> createState() =>
      _AmendTransactionForBuyerPopupState();
}

class _AmendTransactionForBuyerPopupState
    extends State<AmendTransactionForBuyerPopup> {
  String message = "";
                  ...
                  try {
                    ...
                    if (int.parse(quantityController.text.trim(),
                      ...
                      final transactionResponse = await context
                          ...
                          .amendTheRequest(TransactionInputAmend(
                            price: double.parse(priceController.text),
                            quantity: int.parse(quantityController.text),
                            description: descriptionController.text,
                            transactionID: widget.transaction.transactionId,
                            requestID: widget.transactionReq.id,
                          ));
                      setState(() {
                        onProgress = false;
                      });
